...
public final class DatabaseNamesRepository {
    ...
    static final String SELECT_LISTS = "SELECT " + LIST_NAME + " FROM " + TABLE_LISTS;
    ...
    static String getInsertItemToListQuery(int idOfList, String name, int id) {
        return "INSERT INTO " + TABLE_ITEMS + "(" + ITEM_ID_LIST_FOREIGN_KEY + ", " + ITEM_NAME + ", " + ITEM_ID + " , " + ITEM_CHECKED + ") VALUES(" + idOfList + ", \"" + name + "\"," + id + ", 0);";
    }
}
